...
const authToken = localStorage.getItem("budyAuthToken");
...
const AuthSlice = createSlice({
	...
	reducers: {
		clearAuthToken: (state) => {
			...
			localStorage.removeItem("budyAuthToken");
		},
	},
	extraReducers: (builder) => {
		builder
			...
			.addCase(signupUser.fulfilled, (state, action) => {
				...
				localStorage.setItem("budyAuthToken", action.payload.token);
			})
			...
			.addCase(deleteUser.fulfilled, (state) => {
				...
				state.authToken = null;
				state.isLoggedIn = false;
				localStorage.removeItem("budyAuthToken"); // Remove the authToken from localStorage
			})
